...
(function() {
  ...
  ref = require('coffeescript/lib/coffee-script/helpers'), merge = ref.merge, updateSyntaxError = ref.updateSyntaxError;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      ...
      ref1 = require('coffeescript/lib/coffee-script/nodes'), Block = ref1.Block, Assign = ref1.Assign, Value = ref1.Value, Literal = ref1.Literal;
      try {
